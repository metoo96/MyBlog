	...
	<div id="section" class="box">
		...
		<div id="content">
			...
			<?php if(is_array($list)): foreach($list as $key=>$list): ?><li>
					<h2><a href="#"><?php echo ($list['art_title']); ?></a></h2>

					<div class="article-info box">

						<p class="f-right"><a href="#" class="comment"></a></p>

						<p class="f-left"><?php echo date('Y-m-d H:i:s',$list['art_pubtime']); ?>| 作者  <?php echo ($list['art_author']); ?> </p>

					</div> <!-- /article-info -->	

					<p>
					<img src="/myblog/Public/<?php echo ($list['art_thumb_img']); ?>" style="height:100px;width:100px;border:2px solid #999999;border-radius:2px"/>
					</p>
					<p class="more"><a href="<?php echo U('Home/Art/artDetail',array('art_id'=> $list['art_id']));?>">查看全文&raquo;</a></p>
			...
			<div class="pagination box">
				...
				<p class="f-right">
					...
					<a href="<?php echo U('Home/Cat/catDetail',array('cat_id'=>$catid,'p'=>($page-1)));?>">上一页</a>
					<a href="#"><?php echo ($page); ?></a>
					<a href="<?php echo U('Home/Cat/catDetail',array('cat_id'=>$catid,'p'=>($page+1)));?>">下一页 &raquo;</a>
				</p>
