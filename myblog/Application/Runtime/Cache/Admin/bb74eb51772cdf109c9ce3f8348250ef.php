	...
	<div id="section" class="box">
		...
		<div id="content">
			<div style="margin:50px 0px 50px 90px">
				<h2>文章发布</h2>
				<div id="form">
				<form  action="<?php echo U('Admin/Art/addArtAjax');?>" method="post"  enctype="multipart/form-data">
				<ul>
				            <li>
							<label for="input-01">文章标题</label>
							<input type="text" size="45" class="input-text"    placeholder="请输入文章标题" name="art_title"  />
							</li>
							<li>
							<label >文章图标</label>
						    ...
						    <label for="input-01">文章内容</label>
					           ...
					           <script type="text/javascript" charset="utf-8" src="/myblog/Public/Ue/ueditor.all.min.js"> </script>
					            <script type="text/javascript" charset="utf-8" src="/myblog/Public/lang/zh-cn/zh-cn.js"></script>
					             <script id="editor" type="text/plain" name="art_content"style="width:800px;height:400px;"></script>
					            <div>
					    ...
					    var ue = UE.getEditor('editor');
							...
							<input type="text" size="45" class="input-text"    placeholder="请输入文章作者" name="art_author"  />
							</li>
							<li>
	
						<label for="input-01">类别名称</label>
						<select name="art_catid">
						<?php if(is_array($list)): foreach($list as $key=>$l): ?><option value="<?php echo ($l['cat_id']); ?>"><?php echo ($l['cat_name']); ?></option><?php endforeach; endif; ?>
						</select>
						</li>
						<li>
